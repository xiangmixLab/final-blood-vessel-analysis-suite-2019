...
% indices of tracks and detections that remained unassigned. 
    ...
    function [assignments, unassignedTracks, unassignedDetections] = ...
        ...
        for i = 1:nTracks
            cost(i, :) = distance(tracks(i).kalmanFilter1, centroids)+distance(tracks(i).kalmanFilter2, orientation);% larger cost means more unlikely be assigned to a current track
        end
