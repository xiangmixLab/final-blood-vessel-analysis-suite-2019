...
distname={'beta', 'birnbaumsaunders', 'exponential', 'extreme value', 'gamma', 'generalized extreme value','generalized pareto', 'inversegaussian', 'logistic', 'loglogistic','lognormal', 'nakagami', 'normal','rayleigh', 'rician', 'tlocationscale', 'weibull'};
